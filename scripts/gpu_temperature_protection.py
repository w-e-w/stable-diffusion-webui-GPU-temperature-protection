...
shared.options_templates.update(shared.options_section(('GPU_temperature_protection', "GPU Temperature"), {
    ...
    "gpu_temps_sleep_sleep_temp_setup": shared.OptionInfo(75.0, "GPU sleep temperature - setup", gr.Slider, {"minimum": 0, "maximum": 125}).info("generation will pause if GPU core temperature exceeds this temperature"),
    "gpu_temps_sleep_wake_temp_setup": shared.OptionInfo(75.0, "GPU wake temperature - setup", gr.Slider, {"minimum": 0, "maximum": 125}).info("generation will pause until GPU core temperature drops below this temperature"),
    "gpu_temps_sleep_max_sleep_time_setup": shared.OptionInfo(10.0, "Max sleep Time - setup", gr.Number).info("max number of seconds that it's allowed to pause, 0=unlimited"),
}))
